...
<template>
    ...
    <section max-w-md>
        ...
        <p>
          Tooltips, popovers and other UI components called "editor widgets" have a slight contrast against the editor's background so it is easier to distinguish their contents from the code below them.
        </p>
    </section>
    ...
    <div class="preview-shell">
          ...
          sizes="100vw sm:60vw md:70vw lg:50vw 2xl:1080px"
          densities="x1 x2"
        />
      </div>
